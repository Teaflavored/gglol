...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keyboardConstants = __webpack_require__(226);
	...
	var Main = function (_React$Component) {
		...
		_createClass(Main, [{
			...
			value: function handleOnKeyPress(event) {
				if (event.charCode == _keyboardConstants.KEY_CODE_ENTER) {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement("input", { type: "search", onChange: this.handleChange.bind(this),
